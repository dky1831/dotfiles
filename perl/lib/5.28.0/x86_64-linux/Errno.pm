...
"x86_64-linux-4.4.0-17763-microsoft" or
	die "Errno architecture (x86_64-linux-4.4.0-17763-microsoft) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
